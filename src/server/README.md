...
| `0x40` | `create_lens` | 32-byte label + 32-byte source label + 32-byte transform name | — |
| `0x41` | `drop_lens` | 32-byte label | — |
| `0x42` | `query_lens` | 32-byte label + 8-byte timestamp (BE i64) | 1-byte found + 8-byte value (BE f64) if found |
| `0x43` | `compose_lens` | 32-byte new label + 32-byte lens1 label + 32-byte lens2 label | — |
| `0x44` | `list_lenses` | — | N×32-byte labels |
| `0xF0` | OK | varies | — |
...
| `meters_to_feet` | Distance conversion |
| `feet_to_meters` | Distance conversion |
| `returns` | Financial simple returns |
| `log_return` | Financial log returns |
